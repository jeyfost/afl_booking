...
if($_POST['real_time'] == "all_time") {
    ...
    if(count($flights_temp) == 0) {
        echo "<div style='width: 100%; margin-top: 400px; float; left; position: relative;'>There are no flights found in this time interval. Select other aircraft type.</div><div style='clear: both;'></div>";
    } else {
...
if(!empty($flight)) {
    ...
    echo "
        ...
        <p style='margin-left: 2px;'>Your Flight:</p>
        <table>
            <tr class=\"headTR\">
            ...
            <tr>
                ...
                <td><img src='img/flags/".$airport1['iso_code'].".png' title='".$airport1['country']."' /><a target='_blank' title='".$airport1['city']."' href='http://va-aeroflot.su/airport/".$airport1['icao']."'>".$airport1['name']."<br />(".$airport1['icao'].")</a><br /><br />Parking ".$terminal.$stand."</td>
        ...
        <div style='width: 100% margin-top: 20px;' id='weatherBlock'>
            <br />
            <center><p class='showWeatherText' onclick='showWeather(\"".$airport2['icao']."\")'>Show weather at destination and arrival airports</p></center>
        </div>
    ";
}