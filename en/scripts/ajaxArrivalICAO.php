...
if($_POST['arr_icao'] != "") {
    $scheduleResult = $mysqli->query("SELECT * FROM schedule_temp WHERE from_icao LIKE '%".$from."%' AND to_icao LIKE '%".$_POST['arr_icao']."%' ORDER BY number LIMIT 0, 10");
} else {
    $scheduleResult = $mysqli->query("SELECT * FROM schedule_temp WHERE from_icao LIKE '%".$from."%' ORDER BY number LIMIT 0, 10");
}
...
if($_POST['arr_icao'] != "") {
    $countResult = $mysqli->query("SELECT COUNT(number) FROM schedule_temp WHERE from_icao LIKE '%".$from."%' AND to_icao LIKE '%".$_POST['arr_icao']."%'");
} else {
    $countResult = $mysqli->query("SELECT COUNT(number) FROM schedule_temp WHERE from_icao LIKE '%".$from."%'");
}
