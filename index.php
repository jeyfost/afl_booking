...
<body>
    ...
    <div id="content">
        <form id="departureAirportForm" method="post" style="margin-left: 2px;">
            <label for="dep_icao">Аэропорт вылета:</label>
            <br />
        ...
        <form id="arrivalAirportForm" method="post" style="margin-left: 15px;">
            <label for="arr_icao">Аэропорт назначения:</label>
            <br />
        ...
        <table id='scheduleTable'>
            ...
            <?php
                if($count == 0) {
                    echo "<th>К сожалению, доступных рейсов не найдено.</th>";
                }
    ...
    <div id="content2">
        <div id="booking">
            <p>Сгенерировать случайный рейс из Шереметьево</p>
            <form id="generateFlightForm" method="post">
                <div class="radioContainer">
                    <label>Тип самолёта:</label>
                    <br /><br />
                    <input class="radio" type="radio" name="aircraft_type" value="all_types" checked /> Любой тип самолёта<br />
                ...
                <div class="radioContainer" style="margin-left: 20px;">
                    ...
                    <br /><br />
                    <input class="radio" type="radio" name="terminal" value="all_terminals" checked /> Любой терминал<br />
                    <input class="radio" type="radio" name="terminal" value="D" /> Терминал D<br />
                    <input class="radio" type="radio" name="terminal" value="E" /> Терминал E<br />
                    <input class="radio" type="radio" name="terminal" value="F" /> Терминал F
                </div>
                <div class="radioContainer" style="margin-left: 20px;">
                    <label>Привязка к реальному времени:</label>
                    <br /><br />
                    <input class="radio" type="radio" name="real_time" value="all_time" checked /> Без привязки<br />
                    <input class="radio" type="radio" name="real_time" value="real" /> Сгенерировать рейс, вылет которого назначен через 40-80 минут
                </div>
                <div style="clear: both;"></div>
                <br /><br />
                <input type="button" value="Сгенерировать рейс" id="button" />
            </form>
